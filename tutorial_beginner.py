...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.radiobutton_frame = RadioButtonFrame(self, "Options", values=["option 1", "option 2"])
    ...
    def button_callback(self):
        print(f"checked_checkboxes, {self.scrollable_checkbox_frame.get()}")
        print(f"radiobutton_frame, {self.radiobutton_frame.get()}")
